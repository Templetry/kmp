...
- **Never import across forbidden layer boundaries** — screen packages in `:ui` stay self-contained; domain cannot import data:network
...
Follow the 5-step recipe in `MODULE_MAP.md#adding-a-new-screen`.
