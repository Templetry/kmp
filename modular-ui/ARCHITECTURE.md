...
├──────────────────────────────────────────────────────┤
│        ui  (auth │ home │ settings │ profile)        │  ← UI + MVI
├──────────────────────────────────────────────────────┤
...
|-------|---------|---------------|
| App   | `composeApp`, `iosApp` | ui, domain, data, core |
| UI | `:ui` | domain, data:models, core |
...
### MVI
Every screen package in `:ui` has:
...
| `kmpbase.kmp.feature` | The `:ui` module (+ Compose) |
